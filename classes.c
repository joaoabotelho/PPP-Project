...
void new_class(Classes_list head) {
    ...
    if(curr != NULL) {
        ...
        append_class(head, new); // func in "lists/class_list.c"
    }
}
...
void change_clist_data(Classes_list *head) {
        ...
        if((*head)->next != NULL) {
            ...
            get_class(&(*head)); // func in "lists/class_list.c"
...
void remove_class_data(Classes_list head) {
    ...
    if(head->next != NULL) {
        ...
        removes_from_classes_list(copy, head->data); // func in "lists/class_list.c"
